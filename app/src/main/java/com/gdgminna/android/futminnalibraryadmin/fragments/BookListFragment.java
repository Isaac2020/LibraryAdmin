...
import com.gdgminna.android.futminnalibraryadmin.activities.BookDetailActivity;
import com.gdgminna.android.futminnalibraryadmin.models.Book;
import com.gdgminna.android.futminnalibraryadmin.viewholders.BookViewHolder;
...
public abstract class BookListFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions options = new FirebaseRecyclerOptions.Builder<Book>()
                .setQuery(postsQuery, Book.class)
                .build();

        mAdapter = new FirebaseRecyclerAdapter<Book, BookViewHolder>(options) {

            @Override
            public BookViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
                LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
                return new BookViewHolder(inflater.inflate(R.layout.book_item, viewGroup, false));
            }

            @Override
            protected void onBindViewHolder(BookViewHolder viewHolder, int position, final Book model) {
